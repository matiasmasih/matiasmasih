...
<div align="center">
  <div style="max-width: 700px; margin: 0 auto 30px; padding: 30px; border-radius: 25px; background: rgba(29, 53, 87, 0.6); backdrop-filter: blur(10px); border: 2px solid transparent; box-shadow: 0 10px 25px rgba(0,0,0,0.3); color: #ffffff; font-family: 'Fira Code', monospace;">
